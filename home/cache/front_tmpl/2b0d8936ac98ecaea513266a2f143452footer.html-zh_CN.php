...
</script> <?php }  if( $this->_vars['passport_login']=='phpwind7' or $this->_vars['passport_login']=='phpwind' ){ ?> <script>
/*
   ...
   window.addEvent('domready',function(){
     ...
     $(document.body).addEvent('click',function(e){
            ...
            if(tgt.href.test(/\/[\?]?member/i)){
              e.stop();   
              MiniPassport.show(tgt,{remoteURL:'<?php echo tpl_function_link(array('ctl' => "passport",'act' => "login"), $this);?>'});
              miniPassportDialog.store('chain',function(){
                    
                    MessageBox.success('会员认证成功,正在进入...');
                    location.href= '<?php echo tpl_function_link(array('ctl' => "member",'act' => "index"), $this);?>';
     ...
     $$('form[action$=checkout.html]').addEvent('submit',function(e){
            ...
            e.stop();
            var form = this;
            MiniPassport.show(this,{remoteURL:'<?php echo tpl_function_link(array('ctl' => "cart",'act' => "loginBuy"), $this);?>'});
