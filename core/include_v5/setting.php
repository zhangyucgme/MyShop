...
'site.dateFormat'=>array('type'=>SET_T_STR,'default'=>'Y-m-d','desc'=>__('商店日期格式')),
'site.timeFormat'=>array('type'=>SET_T_STR,'default'=>'Y-m-d H:i:s','desc'=>__('商店日期时间格式')),
'site.coupon_order_limit'=>array('type'=>SET_T_STR,'default'=>'','desc'=>__('每张订单可用优惠券数量')),//WZP
'site.decimal_digit'=>array('type'=>SET_T_ENUM,'default'=>2,'desc'=>__('订单金额取整位数'),'options'=>array(0=>__('整数取整'),1=>__('取整到1位小数'),2=>__('取整到2位小数'),3=>__('取整到3位小数'))),//WZP
'site.decimal_type'=>array('type'=>SET_T_ENUM,'default'=>0,'desc'=>__('订单金额取整方式'),'options'=>array('0'=>__('四舍五入'),'1'=>__('向上取整'),'2'=>__('向下取整'))),//WZP
...
'site.market_price'=>array('type'=>SET_T_ENUM,'default'=>'1','desc'=>__('商品页是否显示市场价'),'options'=>array('1'=>'×','2'=>'+')),
'site.market_rate'=>array('type'=>SET_T_STR,'default'=>'1.2','desc'=>__('请输入比例值或增额值')),
...
'site.retail_member_price_display'=>array('type'=>SET_T_ENUM,'default'=>'0','desc'=>__('零售会员价显示设定'),'options'=>array('0'=>__('显示当前会员等级价格'),'1'=>__('显示零售会员所有等级价格'),'2'=>__('显示批发会员所有等级价格'),'3'=>__('显示所有会员等级价格'))),//guzhengxiao
'site.wholesale_member_price_display'=>array('type'=>SET_T_ENUM,'default'=>'0','desc'=>__('批发会员价显示设定'),'options'=>array('0'=>__('显示当前会员等级价格'),'1'=>__('显示零售会员所有等级价格'),'2'=>__('显示批发会员所有等级价格'),'3'=>__('显示所有会员等级价格'))),//guzhengxiao
...
'site.shopex_certify'=>array('type'=>SET_T_ENUM,'options'=>array('0'=>__('显示在底部'),'1'=>__('显示在左侧')),'default'=>'','desc'=>__('ShopEx Store 认证显示')),//WZP
...
'site.logo'=>array('type'=>SET_T_FILE,'default'=>'images/default/default_logo.png|default/default_logo.png|fs_storage','desc'=>__('商店Logo'),'backend'=>'public'),
...
'store.shop_url'=>array('type'=>SET_T_STR,'default'=>'http://'.$_SERVER['HTTP_HOST'].substr(PHP_SELF, 0, strrpos(PHP_SELF, '/') + 1),'desc'=>__('商店网址')),
...
'system.goods.fastbuy'=>array('type'=>SET_T_BOOL,'default'=>true),
...
'system.timezone.default'=>array('type'=>SET_T_INT,'default'=>8,'desc'=>__('用户默认时区')),
...
'site.level_switch'=>array('type'=>SET_T_ENUM,'default'=>'0','options'=>array('0'=>__('按积分'),'1'=>__('按经验值'))),
...
'site.trigger_tax'=>array('type'=>SET_T_BOOL,'default'=>1,'desc'=>__('是否设置含税价格')),//WZP
...
'shopex.wss.username'=>array('type'=>SET_T_STR,'default'=>'','desc'=>__('合作统计用户名')),
'shopex.wss.password'=>array('type'=>SET_T_STR,'default'=>'','desc'=>__('合作统计密码')),
'shopex.wss.enable'=>array('type'=>SET_T_INT,'default'=>'0','desc'=>__('合作统计开关')),
'shopex.wss.show'=>array('type'=>SET_T_INT,'default'=>'0','desc'=>__('合作统计前台开关')),
'shopex.wss.js'=>array('type'=>SET_T_TXT,'default'=>'','desc'=>__('合作统计js')),
...
'goodsprop.display.position'=>array('type'=>SET_T_ENUM,'options'=>array('1'=>__('仅商品价格上方'),'2'=>__('仅商品详情中'),'0'=>__('两处同时显示'))),
...
'gallery.display.grid.colnum'=>array('type'=>SET_T_INT,'default'=>'4','desc'=>__('搜索橱窗页显示行数')),
...
'spec.image.height'=>array('type'=>SET_T_INT,'default'=>30,'desc'=>__('规格图片宽度')),
'spec.image.width'=>array('type'=>SET_T_INT,'default'=>30,'desc'=>__('规格图片高度')),
'spec.default.pic'=>array('type'=>SET_T_STR,'default'=>'images//default/spec_def.gif|//default/spec_def.gif|fs_storage','desc'=>__('规格默认图片')),
'system.editortype'=>array('type'=>SET_T_BOOL,'default'=>'true','desc'=>__('HTML编辑器设置')),
...
'system.store.time'=>array('type'=>SET_T_ENUM,'default'=>0,'desc'=>__('库存预占触发时间'),'options'=>array(1=>'下订单',2=>'订单付款',3=>'订单发货'),'display'=>'false'),
...
'store.quhao'=>array('type'=>SET_T_STR,'default'=>'','desc'=>__('区号')),
'store.qq'=>array('type'=>SET_T_STR,'default'=>'','desc'=>'qq'),
'store.wangwang'=>array('type'=>SET_T_STR,'default'=>'','desc'=>__('旺旺')),
'site.rsc_rpc'=>array('type'=>SET_T_BOOL,'default'=>false,'desc'=>__('优化商店运营数据'))
);
?>